...
public class BaseApiFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //manejador para conocer si hemos alcanzado el inicio o final de scrollview
...
//      **************************************************************************************
//      *****************************Lambda***************************************************
//        new DownloadAsyncTask (s -> parseJSON (s)).execute (URLS.SW_API_PLANETS_URL);
//      **************************************************************************************
//      ** **************************Clase anónima********************************************
//      new DownloadAsyncTask (new OnDownloadFinishedListener () {
//          @Override
//          public void finish(String data) {
//              parseJSON (data);
//          }
//      }).execute (URLS.SW_API_PLANETS_URL);
    }
...
class BaseApiAdapter extends RecyclerView.Adapter<BaseApiAdapter.BaseApiViewHolder> {
    ...
    public void onBindViewHolder (@NonNull BaseApiViewHolder holder, int position) {
        ...
        holder.setData (planet.name, "Diametro: ",planet.diameter, "Poblacion: ",planet.population);
    }
